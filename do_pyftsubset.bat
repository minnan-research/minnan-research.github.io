...
pyftsubset docs/fonts/SourceHanSansTC-Bold.otf --text-file=docs\mistranslation\index.md --output-file=docs/fonts/SourceHanSansTC-Bold-subset.woff2 --flavor=woff2
