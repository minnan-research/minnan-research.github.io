...
但是很明顯像「看**到**你」、「學**到**什麼」，對應的台語應該是「看**著**你」、「學**著**啥物」，不要讀成「學**狗**啥物」囉。
...
且實際上，在表達一些較抽象的動作上，國語這種用法，也是很常見的。比如：
...
這幾個詞組，台語都可以說「予人」（或「互人」），這沒問題。但是口語上有一個特別的語感值得留意：

就是如果這個「予人…」是接近國語的「令人/使人…」或英文的 make 這種主動的意思，口語上就不會連音成「夆 ㄏㄨㄥˇ」。即使說的很快，也會保留「人」的子音 ㄌ。
...
這種 **叫** 是 **使/讓** 的意思。如果直翻成「**叫**人受氣」、「**叫**伊歡喜」意思是完全不同的。應翻成如：「**使**人受氣」、「**互**伊歡喜」。
