...
國語演說結尾的「讓我們……」是一個提議與號召，並不是要導致我們怎麼樣。如果照翻台語「互咱……」就會有一種導致我們怎樣的感覺。
...
台語「事實上」通常是 actually 的意思，目的是要反駁前一句話。但國語「事實上」或英文的 "in fact" 則可能是要補充說明或加強論點。

若國語的「事實上」是這種情況，不可照翻為台語。台語看來沒有直接對應的連接詞，視語意可以說：「論真」、「所以」、「而且」、「因為」、「應該講」、「確實」、「其實」等等…。也可能要改變句子結構，或是直接省略。
