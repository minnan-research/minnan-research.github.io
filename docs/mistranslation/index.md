...
國語演說結尾的「讓我們…」是一個提議與號召，並不是要導致我們怎麼樣。如果照翻台語「予(互)咱…」就會有一種導致我們怎樣的感覺。

可以說「願咱…」就好了，國語也可以用「願我們…」。
...
華語的「**事實上**」或英文的 **in fact** 則常常是要**補充說明或加強論點**。但在台語口語上，「**事實上**」通常是 **actually** 的意思，目的是要反駁前一句話。

若華語這種補充說明或加強論點的「**事實上**」直翻為台語，口語上可能不是那麼自然，或可能讓一些人誤會是要反駁前一句話。（但台語新聞是經常這樣使用的，所以這點也是見仁見智。）

若要改成比較自然的台語，視語意可以改成說：「論真」、「而且」、「甚至」、「同時」、「所以」、「因為」、「應該講」、「其實」等等…。
...
教育部辭典並沒有收錄跟國語一樣的這個詞義，但是例句卻有不少。建議在教育部台語辭典 [用「總是」搜尋例句](https://sutian.moe.edu.tw/zh-hant/tshiau/?lui=tai_ku&tsha=%E7%B8%BD%E6%98%AF)，多看多聽即可知兩者差異。
...
國語另一種「動詞+起來」例如「**看起來**沒問題」，台語也很常用，可以國語一樣用法。
