...
幾乎沒有字典收錄「**彼寡**」，看來有可能是受國語影響產生的國語式說法。
...
**但是**，也不該為了避免用 **了** 就**直接**把他從句子拿掉，因為這樣**時態**會不見。  
特別是簡單的句子如：「他記錄**了**整件事情。」這句話的**了**是要表達完成的感覺，如果翻譯直接拿掉**了**：「伊記錄 整個事件。」時態就不見了，感覺話沒有說完，好像後面還有話要說：「伊記錄整個事件，是欲……」這樣不如不拿掉**了**還比較好。

但最好還是可以換成更台語的說法：「伊**有**記錄整個事件。」「伊給整個事件記錄**落來**。」裡面的 **有** 跟 **落來** 就可以表達出完成的感覺了。
